...
# iPhone App Icons
rsvg-convert -w 180 -h 180 "$SVG_FILE" > icons/AppIcon-60@3x.png  # iPhone 180x180
rsvg-convert -w 120 -h 120 "$SVG_FILE" > icons/AppIcon-60@2x.png  # iPhone 120x120
rsvg-convert -w 87 -h 87 "$SVG_FILE" > icons/AppIcon-29@3x.png    # iPhone Settings 87x87
rsvg-convert -w 58 -h 58 "$SVG_FILE" > icons/AppIcon-29@2x.png    # iPhone Settings 58x58
rsvg-convert -w 80 -h 80 "$SVG_FILE" > icons/AppIcon-40@2x.png    # iPhone Spotlight 80x80
rsvg-convert -w 120 -h 120 "$SVG_FILE" > icons/AppIcon-40@3x.png  # iPhone Spotlight 120x120
rsvg-convert -w 40 -h 40 "$SVG_FILE" > icons/AppIcon-20@2x.png    # iPhone Notifications 40x40
rsvg-convert -w 60 -h 60 "$SVG_FILE" > icons/AppIcon-20@3x.png    # iPhone Notifications 60x60

# iPad App Icons
rsvg-convert -w 152 -h 152 "$SVG_FILE" > icons/AppIcon-76@2x.png  # iPad 152x152
rsvg-convert -w 76 -h 76 "$SVG_FILE" > icons/AppIcon-76.png       # iPad 76x76
rsvg-convert -w 167 -h 167 "$SVG_FILE" > icons/AppIcon-83.5@2x.png # iPad Pro 167x167

# Universal Settings and Spotlight
rsvg-convert -w 29 -h 29 "$SVG_FILE" > icons/AppIcon-29.png       # Settings 29x29
rsvg-convert -w 40 -h 40 "$SVG_FILE" > icons/AppIcon-40.png       # Spotlight 40x40

# App Store Icon (1024x1024)
rsvg-convert -w 1024 -h 1024 "$SVG_FILE" > icons/AppIcon-1024.png

# Additional common sizes
rsvg-convert -w 512 -h 512 "$SVG_FILE" > icons/AppIcon-512.png
rsvg-convert -w 256 -h 256 "$SVG_FILE" > icons/AppIcon-256.png
rsvg-convert -w 128 -h 128 "$SVG_FILE" > icons/AppIcon-128.png
rsvg-convert -w 64 -h 64 "$SVG_FILE" > icons/AppIcon-64.png
