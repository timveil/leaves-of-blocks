...
struct GameStatChip: View {
    ...
    enum StatChipStyle {
        ...
        var fontSize: Font {
            switch self {
            case .compact: return GameTheme.Typography.compactBody
            case .standard: return GameTheme.Typography.standardBody
            case .featured: return GameTheme.Typography.secondaryHeader
            }
        }
