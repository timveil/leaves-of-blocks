...
struct GameStatChip: View {
    ...
    enum StatChipStyle {
        ...
        var fontSize: Font {
            switch self {
            case .compact: return GameTheme.Typography.captionFont
            case .standard: return GameTheme.Typography.bodyFont
            case .featured: return GameTheme.Typography.headlineFont
            }
        }
...
#if DEBUG
struct StatisticalDisplays_Previews: PreviewProvider {
    static var previews: some View {
        ScrollView {
            VStack(spacing: 20) {
                // Stat chips
                HStack {
                    GameStatChip(title: "Score", value: "1,245", icon: "star.fill", style: .compact)
                    GameStatChip(title: "Lines", value: "12", icon: "square.grid.3x3", style: .standard)
                    GameStatChip(title: "Best", value: "2,890", icon: "crown.fill", color: .orange, style: .featured)
                }
